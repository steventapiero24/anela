...
const ConfirmationView = ({ setStep }) => (
  <div className="text-center p-12 bg-white rounded-[3.5rem] shadow-xl border border-gray-50 mt-10">
    ...
    <button onClick={() => setStep('home')} className="w-full bg-[#3D5645] text-white py-5 rounded-3xl font-bold shadow-xl text-[10px] uppercase tracking-widest">Ver mis citas</button>
  </div>
);

...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-gray-200 py-6">
      ...
      {/* Animación fluida para el acordeón */}
      <motion.div 
        initial={false}
      ...
      >
        <p className="text-gray-500 text-sm leading-relaxed max-w-2xl text-left mt-4">
          {answer}
        </p>
      </motion.div>
    </div>
...
const App = () => {
  ...
  const faqs = [
    { question: "¿Cuánto tiempo dura el esmaltado semipermanente?", answer: "Nuestros esmaltes de alta gama están diseñados para durar entre 15 y 21 días con un brillo impecable, dependiendo del crecimiento natural de tu uña y los cuidados posteriores." },
    { question: "¿Sus productos son libres de tóxicos?", answer: "Totalmente. Utilizamos fórmulas '10-Free', lo que significa que están libres de los 10 componentes químicos más dañinos presentes en los esmaltes convencionales." },
    { question: "¿Es necesario pedir cita previa para pedicura?", answer: "Para garantizarte una experiencia de relajación completa y sin esperas, recomendamos agendar tu cita con al menos 48 horas de antelación." },
    { question: "¿Cuánto dura una cita de manicura o pedicura?", answer: "La duración depende del servicio. Una manicura semipermanente suele durar entre 45 y 60 minutos, mientras que servicios más completos o con diseño pueden requerir más tiempo." },
    { question: "¿Puedo acudir sin cita previa?", answer: "Trabajamos principalmente con cita previa para garantizar la mejor atención. Si tenemos disponibilidad, estaremos encantadas de atenderte sin cita." },
    { question: "¿Qué pasa si llego tarde a mi cita?", answer: "Te recomendamos llegar puntual para disfrutar de tu servicio completo. En caso de retraso, es posible que tengamos que adaptar o reprogramar tu cita." },
    { question: "¿Cuál es la política de cancelación?", answer: "Puedes cancelar o modificar tu cita con al menos 24 horas de antelación. Esto nos permite reorganizar la agenda y ofrecer el espacio a otra clienta." },
    { question: "¿Retiran esmalte o uñas de otros centros?", answer: "Sí, realizamos retiradas de trabajos de otros centros. Te recomendamos indicarlo al reservar para asignarte el tiempo adecuado." },
    { question: "¿Se dañan las uñas con el esmaltado semipermanente?", answer: "No, siempre que se aplique y retire correctamente. En Anela Nails priorizamos la salud de tu uña natural utilizando técnicas seguras y productos de calidad." },
    { question: "¿Hacen diseños personalizados?", answer: "Sí, nos encanta personalizar cada manicura. Puedes traer tu idea o inspirarte con nuestros diseños en el estudio." },
    { question: "¿Cómo debo preparar mis uñas antes de la cita?", answer: "Recomendamos acudir con las uñas limpias y sin producto previo. Si llevas esmalte o uñas de otro centro, indícalo al reservar." },
    { question: "¿Ofrecen tarjetas regalo?", answer: "Sí, disponemos de tarjetas regalo perfectas para sorprender con una experiencia de belleza y cuidado." },
    { question: "¿Qué métodos de pago aceptan?", answer: "Aceptamos efectivo, tarjeta y otros métodos digitales para tu comodidad." },
    { question: "¿Puedo cambiar el servicio una vez en el estudio?", answer: "Intentaremos adaptarnos siempre que nuestra agenda lo permita, aunque recomendamos elegir el servicio correctamente al reservar." }
  ];

  // Variantes para animaciones en cascada (Stagger)
  const fadeInUp = {
  ...
  return (
    <div className="min-h-screen font-sans text-[#2D2D2D] selection:bg-[#4A5D4E] selection:text-white bg-[#F8F7F2]">
      ...
      <motion.nav 
        ...
        className='flex px-5 md:px-0 pt-5'
      >
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 md:py-20">
        ...
        >
          <div>
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-6xl font-serif tracking-tight leading-[1.1] max-w-md text-left">
              Un ritual para tus manos.
            </motion.h1>
            <motion.p variants={fadeInUp} className='text-left text-gray-500 mt-2'>Más que una manicura.</motion.p>
            <motion.div variants={fadeInUp} className='flex items-start'>
              <button
                onClick={() => navigate('/agenda')}
                className="btn-agenda cursor-pointer mt-6 text-white px-8 py-4 rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-[#3b4a3e] transition-colors"
              >
                Quiero mi cita
              </button>
            </motion.div>
          ...
          <motion.div variants={fadeInUp} className="flex items-center gap-3 pb-2">            
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-24">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-2xl max-w-[260px] border border-white/20"
            >
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            ...
            {/* 2. Tarjeta Pedicura SPA */}
            <motion.div 
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.5, ease: [0.25, 0.1, 0.25, 1] }}
              className="bg-[#EAE8E1] p-10 rounded-2xl flex-1 flex justify-between relative overflow-hidden group"
            >
              ...
              <div className="bottom-0 right-0 w-full h-3/5 absolute">
                <img 
                  src="https://plus.unsplash.com/premium_photo-1661499249417-c20d6b668469?q=80&w=400&auto=format&fit=crop" 
                  alt="Relajación de pies con aceites" 
                  className="w-full h-full object-cover rounded-tl-3xl shadow-[-20px_-20px_40px_rgba(0,0,0,0.05)] group-hover:scale-105 transition-transform duration-700" 
                  loading="lazy"
                />
              </div>
            </motion.div>

            {/* 3. Tarjeta Esmaltes 10-Free */}
            <motion.div 
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.7, ease: [0.25, 0.1, 0.25, 1] }}
              className="bg-primary p-10 rounded-2xl text-white relative overflow-hidden"
            >
              <div className="flex gap-8 items-center relative z-10">
                <div className="w-28 h-44 overflow-hidden rounded-full shrink-0 shadow-2xl">
                  <img 
                    src="https://images.unsplash.com/photo-1619607146034-5a05296c8f9a?q=80&w=687&auto=format&fit=crop" 
        ...
        {/* Sección de Testimonio (Aparece al hacer scroll) */}
        <motion.div 
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.8 }}
          className="text-center max-w-3xl mx-auto mb-32 flex flex-col items-center"
        >
        ...
        {/* Sección de Productos/Servicios con Piedras (Flotado Cinematográfico) */}
        <motion.div 
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 1 }}
          className="relative py-20 flex flex-col items-center mb-32"
        >
          <div className="relative z-10 flex flex-col md:flex-row items-end justify-center gap-12 md:gap-4">
            ...
            <motion.div 
              ...
              className="relative group translate-y-8"
            >
              <img 
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1602585578130-c9076e09330d?q=80&w=400&auto=format&fit=crop" 
